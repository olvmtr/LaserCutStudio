/**
 * @file TransformationCommandBase.cpp
 * @brief Implémentation de la classe de base pour commandes de transformation
 */

#include "core/models/editor/base/TransformationCommandBase.h"
...
TransformationCommandBase::TransformationCommandBase(const QVector<IShape*>& shapes,
                                                     QObject* parent)
...
TransformationCommandBase::~TransformationCommandBase()
{
...
bool TransformationCommandBase::isObsolete() const
{
...
bool TransformationCommandBase::validateTransformState(bool isRedo) const
{
...
bool TransformationCommandBase::validateUndoState() const
{
...
bool TransformationCommandBase::shapesMatch(const QVector<IShape*>& other) const
{
    // Vérifier la taille
...
void TransformationCommandBase::recordInitialPositions()
{
...
void TransformationCommandBase::markExecuted()
{
    m_executed = true;
...
void TransformationCommandBase::markUndone()
{
    m_executed = false;
